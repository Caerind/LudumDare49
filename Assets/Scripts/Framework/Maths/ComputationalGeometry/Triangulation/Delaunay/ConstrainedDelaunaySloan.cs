...
namespace Habrador_Computational_Geometry
{
    ...
    {
        public static HalfEdgeData2 GenerateTriangulation(List<MyVector2> points, List<MyVector2> hull, HashSet<List<MyVector2>> holes, bool shouldRemoveTriangles, HalfEdgeData2 triangleData)
        {
