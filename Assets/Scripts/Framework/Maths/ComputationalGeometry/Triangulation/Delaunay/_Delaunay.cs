...
namespace Habrador_Computational_Geometry
{
    public static class _Delaunay
    {
        ...
        public static HalfEdgeData2 ConstrainedBySloan(List<MyVector2> points, List<MyVector2> hull, HashSet<List<MyVector2>> holes, bool shouldRemoveTriangles, HalfEdgeData2 triangleData)
        {
