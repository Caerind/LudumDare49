...
namespace CommandTerminal
{
    ...
    public class Terminal : Singleton<Terminal>
    {
        ...
        [SerializeField] KeyCode ToggleHotkey;
        [SerializeField] KeyCode ToggleFullHotkey;
        ...
        void OnGUI() {
            if (Event.current.Equals(Event.KeyboardEvent(ToggleHotkey.ToString()))) {
                SetState(TerminalState.OpenSmall);
                initial_open = true;
            } else if (Event.current.Equals(Event.KeyboardEvent(ToggleFullHotkey.ToString()))) {
        ...
        void DrawConsole(int Window2D) {
            ...
            } else if (Event.current.Equals(Event.KeyboardEvent(ToggleHotkey.ToString()))) {
